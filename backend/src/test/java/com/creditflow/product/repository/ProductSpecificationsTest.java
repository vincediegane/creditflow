...
class ProductSpecificationsTest {
    ...
    void inShopsReturnsNullWhenEmpty() {
        assertThat(ProductSpecifications.inShops(null)).isNull();
        assertThat(ProductSpecifications.inShops(List.of())).isNull();
    }
    ...
    void inShopsFiltersOnShopId() {
        ...
        Specification<Product> specification = ProductSpecifications.inShops(List.of(1L, 2L));
