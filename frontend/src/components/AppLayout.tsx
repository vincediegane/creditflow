...
const NAV_ITEMS = [
  ...
  { to: '/fournisseurs', label: 'Fournisseurs', icon: <LocalShippingIcon />, adminOnly: true },
  { to: '/achats', label: 'Achats', icon: <AddShoppingCartIcon />, adminOnly: true },
  ...
  { to: '/reprise', label: 'Reprise de données', icon: <UploadFileIcon />, adminOnly: true },
